...
void FaceBuilder::BuildFace(Mesh& vertices, Faces Direction, glm::vec3 Pos, BlockTypes block, BlockShapes Shape)
{
	...
	case CrossShape:
		...
		case ACross:
			...
			vertices.AddToVerticies(Vertex(((x + 1) | (y << 5) | ((z+1) << 15) | (1 << 20) | (00 << 22) | (block << 24))));
			vertices.AddToVerticies(Vertex(((x + 1) | ((y + 1) << 5) | ((z + 1) << 15) | (3 << 20) | (00 << 22) | (block << 24))));
			vertices.AddToVerticies(Vertex(((x + 1) | ((y + 1) << 5) | ((z + 1) << 15) | (3 << 20) | (00 << 22) | (block << 24))));
			vertices.AddToVerticies(Vertex((x | ((y + 1) << 5) | (z  << 15) | (2 << 20) | (00 << 22) | (block << 24))));
			vertices.AddToVerticies(Vertex((x | (y << 5) | (z << 15) | (0 << 20) | (00 << 22) | (block << 24))));

			break;
		case BCross:
			vertices.AddToVerticies(Vertex((x | (y << 5) | ((z+1) << 15) | (0 << 20) | (00 << 22) | (block << 24))));
			vertices.AddToVerticies(Vertex(((x + 1) | (y << 5) | (z << 15) | (1 << 20) | (00 << 22) | (block << 24))));
