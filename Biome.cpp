...
{
	chunkmenager->SetBlockInWorld(WorldPos + glm::vec3(0, 0, 0), BlockTypes::Water);
	chunkmenager->SetBlockInWorld(WorldPos + glm::vec3(1, 0, 0), BlockTypes::Water);
	chunkmenager->SetBlockInWorld(WorldPos + glm::vec3(0, 0, 1), BlockTypes::Water);
	chunkmenager->SetBlockInWorld(WorldPos + glm::vec3(-1,0, 0), BlockTypes::Water);
	chunkmenager->SetBlockInWorld(WorldPos + glm::vec3(0, 0, -1),BlockTypes::Water);
